...
angular.module('esn')
    .controller('CreateGroupCtrl', function ($scope, $http, $location) {
        ...
        $scope.setRightMenuSrc('views/group/groupmenu.html');
        $scope.updateView('Announcements', false);
        ...
        $scope.seeRequests = function () {
            $scope.updateView('Requests', true);

        };
    })
    .controller('GroupMenuController', function ($scope) {
        var $menus = ['Announcements', 'Tasks', 'Posts', 'Questions', 'Contents', 'Users', 'Requests'];
        ...
        $scope.selectMenu = function (index) {
            if (index >= 0 && index < $scope.data.menus.length) {
                ...
                $scope.updateView($selectedMenu, true);
            }
        };
